...
const en = {
  ...
  auth: {
    login: {
      ...
      forgotPin: 'Forgot PIN? Call Dispatch',
      ticker: ['Sousse Hub Open', '14 Routes Today', 'Clear Skies 31°C'],
      newDriver: "New driver? ",
      createAccount: 'Create account',
      errors: {
        invalidCredentials: 'Incorrect phone number or PIN.',
      },
    },
    register: {
      step1: {
  ...
  jobDetail: {
    ...
    rescheduleToast: 'Reschedule — coming soon',
  ...
  pickups: {
    ...
    addSpontaneous: 'Add Walk-In Pickup',
    addSpontaneousSubtitle: 'Merchant called you directly',
    empty: {
  ...
  transfers: {
    ...
    to: 'To',
    you: 'You',
    showQr: 'Show Handoff QR',
    qrInfoNote: 'Both couriers must scan the same QR within 5 minutes to confirm custody.',
    empty: 'No transfers in progress',
  },

  returns: {
    headerTitle: 'Returns',
    eyebrow: 'Sender Returns',
    inBagLabel: 'In Bag',
    orderNumber: 'Order #{{id}}',
    scan: 'Scan',
    addPhotoToast: 'Photo — coming soon',
    scanAll: 'Scan All',
    scanNote: 'Returns must be scanned at the depot before closing out the route.',
  ...
  profile: {
    ...
    stats: { lifetimeDeliveries: 'Deliveries', onTimeRate: 'On Time', weeklyCash: 'DT / Week' },
    sectionAccount: 'Account',
    sectionSupport: 'Support',
    rows: {
      personalInfo: 'Personal Info',
      vehicleDetails: 'Vehicle & Documents',
      bankInfo: 'Cash & Payouts',
