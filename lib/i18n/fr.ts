...
const fr: TranslationResource = {
  ...
  runsheets: {
    ...
    reorderHint: 'Maintenez la poignée et glissez pour réordonner vos arrêts',
  ...
  pickups: {
    ...
    navigate: 'Naviguer',
    parcelsTitle: 'Colis',
    doneAll: 'Tout collecter',
    doneAllConfirmTitle: 'Marquer toutes les collectes',
    doneAllConfirmMessage: 'Marquer les {{count}} collectes prévues comme collectées ? Cela évite de scanner chaque colis.',
    doneAllToast: 'Toutes les collectes sont marquées',
    empty: {
  ...
  transfers: {
    ...
    detailLine: '{{count}} colis · {{location}} · {{time}}',
